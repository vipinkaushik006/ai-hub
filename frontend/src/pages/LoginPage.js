...
export default function LoginPage() {
  ...
  return (
    <>
      <SEO title="Login" description="Sign in to your AIHub account to bookmark tools, rate AI tools, and access personalized features." />
      <div className="min-h-screen flex items-center justify-center px-4 pt-16">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mt-4 card p-4 text-center">
            <p className="text-slate-500 text-xs mb-1">Demo admin credentials:</p>
            <p className="text-slate-400 text-xs font-mono">admin@aihub.com / Admin@123456</p>
          </div>
        </div>
      </div>
    </>
