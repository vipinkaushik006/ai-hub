...
export default function BlogDetailPage() {
  ...
  if (loading)
    return (
      <div className="pt-24 text-center text-slate-400 py-20">
        Loading article...
      </div>
    );
  if (!blog)
    ...
    <>
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          {/* Article header */}
          <div className="mb-8">
            <span className="badge bg-primary-500/20 text-primary-300 border border-primary-500/20 mb-4 inline-block">
              {blog.category}
            </span>
            <h1 className="font-display font-extrabold text-3xl md:text-4xl text-white leading-tight mb-4">
              {blog.title}
            </h1>
